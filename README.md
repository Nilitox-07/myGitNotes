...
git merge <branchName>                  # Merges from the selected branch into the current branch
git tag -a '<version>' -m '<msg>'       # tagging an annotated tag with msg
git remote add <origin> <url>           # addin a remote
